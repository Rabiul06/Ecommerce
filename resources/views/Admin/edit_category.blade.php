				...
				<form class="form-horizontal" action="{{url('/update-category/'.$save_category->category_id)}}" method="post">
				  ...
				  <fieldset>
					<div class="control-group">
					  ...
					  <div class="controls">
						<input type="text"  name="category_name" value="{{$save_category->category_name}}"> 
					  </div>
					</div>  
					...
					<div class="control-group hidden-phone">
					  ...
					  <div class="controls">
						<textarea class="cleditor" name="category_description"  rows="3" >{{$save_category->category_description}} </textarea>
					  </div>
					</div>
					<div class="alert-danger"></div>
					<div class="control-group hidden-phone">
