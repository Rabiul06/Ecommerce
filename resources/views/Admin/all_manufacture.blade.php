				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  ...
				  <tbody>
					...
					<tr>
						...
						<td class="center">
							@if($manufacture->manufacture_status==1)
							<a class="btn btn-danger" href="{{URL::to('/unactiv_manufacture/' .$manufacture->manufacture_id)}} ">
							<i class="halflings-icon white thumbs-down"></i>  
							</a>
							@else
								<a class="btn btn-success" href="{{URL::to('/activ_manufacture/'.$manufacture->manufacture_id)}}">
							...
							<a class="btn btn-danger" href="{{URL::to('/delete-manufacture/'.$manufacture->manufacture_id)}}">
