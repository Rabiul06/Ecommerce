			...
			<div class="row-fluid">
				<div class="login-box">
                   ...
                   if($messege){
					...
					<form class="form-horizontal" action="{{url('/admin_dashbord')}}" method="post">
						{{csrf_field()}}
						<fieldset>
							
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="admin_email" type="text" required="" placeholder="Type email"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_password" type="password" required="1" placeholder="Type password"/>
							</div>
